...
public final class PacketStand {
    ...
    // Plugin instance.
    private final CigarettePlugin plugin = JavaPlugin.getPlugin(CigarettePlugin.class);
    ...
    static {
        ...
        DATA_COMPONENT_TYPE = XReflection.supports(20, 6) ? Reflection.getFieldValue(Reflection.getField(BUILT_IN_REGISTRIES, DEFAULTED_REGISTRY, "as", true, "DATA_COMPONENT_TYPE")) : null;
